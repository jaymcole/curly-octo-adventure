...
import curly.octo.common.map.generators.templated.TemplateManager;
import curly.octo.common.map.generators.templated.TemplateRoom;

import java.util.*;
import java.util.stream.Collectors;

import static curly.octo.common.map.generators.templated.TemplateManager.*;
