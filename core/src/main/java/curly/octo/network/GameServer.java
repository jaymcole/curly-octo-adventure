...
//                        gameWorld.removePlayerFromEnvironment(disconnectedPlayer);
    ...
    public void regenerateMap(long newSeed, String reason) {
        ...
        try {
            ...
            // Step 2: Clear cached map data to force fresh serialization
            serializedMaps.clear();
            
            // Step 3: Ask the game world to regenerate the map
            if (gameWorld != null) {
            ...
            // Step 4: Give clients a moment to clean up their resources
            Thread.sleep(500);
            
            // Step 5: Send new map to all connected clients
            Log.info("GameServer", "Broadcasting new map to all clients");
